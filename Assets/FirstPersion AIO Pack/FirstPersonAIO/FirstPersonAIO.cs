...
public class FirstPersonAIO : MonoBehaviour
{
    ...
    private void Update(){
        ...
        {
            GameObject bullet = Instantiate(projectile, transform.position + (playerCamera.transform.forward * 2), Quaternion.identity) as GameObject;
            bullet.GetComponent<Rigidbody>().AddForce(playerCamera.transform.forward * 50000);
        }
        #endregion
    ...
    public class FPAIO_Editor : Editor{
        ...
        #region Camera Setup
            ...
            EditorGUILayout.Space();
            t.projectile = (GameObject) EditorGUILayout.ObjectField(new GUIContent("Projectile", "Is a projectile"),
                t.projectile, typeof(GameObject), true);
            EditorGUILayout.Space();
